...
addnode=80.240.30.38:46123
addnode=193.142.214.100:46123
addnode=70.38.74.90:46123
addnode=68.195.18.155:46123
addnode=221.140.248.6
addnode=207.148.75.5:46123 
addnode=149.28.55.22:46123 
addnode=207.148.113.42:46123
addnode=192.243.108.19:46123
addnode=202.182.120.86:46123
addnode=45.76.54.93:46123
EOF
}
...
function important_information() {
 echo
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${PURPLE}Windows Wallet Guide. https://github.com/Realbityoda/Apeiron/master/README.md${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 ...
 echo -e "${GREEN}apeiron-cli masternode status${NC}"
 echo -e "${GREEN}apeiron-cli getinfo.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${RED}Donations always excepted gratefully.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${YELLOW}APEIR: AYv52LvQed5zSobq7MKLYzMEMxgzfWYcpx${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
