![Example-Logo](https://i.imgur.com/ZJxxvwl.png)
...
`wget -q https://raw.githubusercontent.com/Realbityoda/Apeiron/master/apeiron_install.sh`
***
...
***Step 1***
* Download and install the Node-X wallet [here]https://github.com/apeironcoin/apeiron/releases)
***

***Step 2***
* Send EXACLY 1,000 Apeiron to a receive address within your wallet.
***
